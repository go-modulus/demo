...
func NewUserLoaderDefaultCache() *UserLoaderDefaultCache {
	return &UserLoaderDefaultCache{cache: make(map[uuid.UUID]storage.User)}
}

func (d *UserLoaderDefaultCache) Set(key uuid.UUID, value storage.User) {
	d.cache[key] = value
}

func (d *UserLoaderDefaultCache) Get(key uuid.UUID) (storage.User, bool) {
	it, ok := d.cache[key]
	return it, ok
}

func (d *UserLoaderDefaultCache) Del(key uuid.UUID) {
	delete(d.cache, key)
}
...
func (d *UserLoaderNullCache) Set(key uuid.UUID, value storage.User) {
}

func (d *UserLoaderNullCache) Get(key uuid.UUID) (storage.User, bool) {
	return storage.User{}, false
}

func (d *UserLoaderNullCache) Del(key uuid.UUID) {
}
